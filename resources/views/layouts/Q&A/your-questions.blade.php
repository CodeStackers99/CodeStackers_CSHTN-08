@extends('layouts.app')
@section('title', 'Your Questions | WebAcquire')

@section('content')
<div class="container">
    <div class="section d-flex flex-column align-items-center">
        <span class="my-underline-2"></span>
        <h2 class="text-hblack font-weight-bold text-capitalize mt-3 animate_animated animate__heartBeat animate_slow sub-heading">Your Questions</h2>
    </div>
    ...
    <div class="section">
        @if ($yourQuestions->count() > 0)
        <div class="row justify-content-center">
            <div class="col-md-16">
                @foreach ($yourQuestions as $question)
    ...
    @else
        @include('layouts.Q&A.Question._no-questions-found')
    @endif
    </div>
    @include('layouts.Q&A.Question._create')
    <div class=" d-flex justify-content-center my-shadow ">
        {{ $yourQuestions->appends(['search' => request('search')])->links() }}
    </div>
</div>
@endsection
