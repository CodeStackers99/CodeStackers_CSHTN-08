@extends('layouts.app')
@section('title', 'Edit Question | WebAcquire')
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <h1 class="p-0 m-0 ml-2">Edit Question</h1>
                <div class="card my-card p-0 m-0 mt-3 mb-5">
                        <div class="card-body">
                            <form action="{{ route('questions.update', $question->id) }}" method="POST" id="edit-question-form">
                                @csrf
                                @method('PUT')
