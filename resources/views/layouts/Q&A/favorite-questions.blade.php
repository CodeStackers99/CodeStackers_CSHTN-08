@extends('layouts.app')
@section('title', 'Favorite Questions | WebAcquire')

@section('content')
<div class="container">
    <div class="section d-flex flex-column align-items-center">
        <span class="my-underline-2"></span>
        <h2 class="text-hblack font-weight-bold text-capitalize mt-3 animate_animated animate__heartBeat animate_slow sub-heading">Favorite Questions</h2>
    </div>
                                    ...
                                    <div class="action-buttons d-flex m-1">
                                        ...
                                        @can('delete', $question)
                                            <button
                                                ...
                                                title="Delete favorite question">
