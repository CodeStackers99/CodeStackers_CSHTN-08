@extends('layouts.app')
@section('title', 'Questions you Answered | WebAcquire')

@section('content')
<div class="container">
    <div class="section d-flex flex-column align-items-center">
        <span class="my-underline-2"></span>
        <h2 class="text-hblack font-weight-bold text-capitalize mt-3 animate_animated animate__heartBeat animate_slow sub-heading">Questions you Answered</h2>
    </div>
    ...
    <div class="section">
        @if ($questionsYouAnswered->count() > 0)
        <div class="row justify-content-center">
            <div class="col-md-16">
                @foreach ($questionsYouAnswered as $question)
