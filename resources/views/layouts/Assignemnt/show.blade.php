...
@section('content')
    <div class="container">
        <div class="section d-flex flex-column align-items-center">
            ...
            <h2 class="text-hblack font-weight-bold text-capitalize mt-3 animate_animated animate__heartBeat animate_slow sub-heading">{{ $assignment->title }}</h2>
        </div>
        <div class="section card">
            <form action="{{$assignment->url. '/check'}}" method="POST" id="solve-assignemnt">
                @csrf
                <div class="card-body">
